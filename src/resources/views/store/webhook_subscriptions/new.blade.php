...
@section('title', 'Add Webhook Subscription')

@section('page-title', 'Add Webhook Subscription')

@section('content')
<div class="container max-w-lg">
    <div class="bg-white rounded shadow p-8">
        {!! html()->form('POST', route('store.webhook_subscriptions.new'))
            ->class('space-y-6')
            ->open() !!}
            ...
            <div class="flex justify-end space-x-3">
                ...
                {!! html()->button('Create Subscription')
                    ->type('submit')
