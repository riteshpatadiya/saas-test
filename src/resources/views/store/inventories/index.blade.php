...
<div class="container mx-auto space-y-8">
    <div class="bg-white rounded shadow p-6">
        ...
        <form method="GET" action="{{ route('store.inventories.index') }}" class="flex flex-wrap items-center gap-3" id="inventoryFilterForm">
                    ...
                    @forelse($variantStocks as $row)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a
                                    href="{{ route('store.inventories.show', ['variant' => $row->id]) }}"
