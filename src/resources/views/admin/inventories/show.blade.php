...
<div class="container mx-auto space-y-6">
    <div>
        <a href="{{ route('admin.inventories.index') }}" class="text-sm text-blue-600 hover:underline">&larr; Back to all inventory</a>
    </div>
    ...
    <div class="bg-white rounded shadow p-6 space-y-6">
        <div>
            ...
            <p class="text-sm text-gray-600">
                ...
                Store: {{ optional($variant->store)->name }}
            </p>
        </div>
        ...
        @if($locations->isNotEmpty())
            <div class="border-t pt-6 space-y-8">
                <div>
                    ...
                    {!! html()->form('POST', route('admin.inventories.adjust'))
                        ->class('space-y-4')
                        ->open() !!}
